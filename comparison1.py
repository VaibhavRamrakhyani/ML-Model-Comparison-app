...
st.set_page_config("MACHINE LEARNING COMPARISON APP", layout="wide")
...
def build_model(df):
    ...
    st.write('X variable (First 10 Columns)')
    ...
    st.subheader("Plot Model Performance (Test set)")
...
with st.sidebar.header("Set Parameter"):
...
if uploaded_file is not None:
    ...
    st.markdown("Parameter of the Dataset")
    st.write(df)
    build_model(df)
